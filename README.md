...
- [Advanced User Guide](#advanced-user-guide)
	- [Extend osixia/openldap:1.2.3 image](#extend-osixiaopenldap122-image)
...
Do not forget to add the port mapping for both port 389 and 689 if you wish to access the ldap server from another machine.
	...
	docker run -p 389:389 -p 689:689 --name my-openldap-container --detach osixia/openldap:1.2.3
